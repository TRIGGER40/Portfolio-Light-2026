...
Note: There is no separate "Gen AI Explorations" case study. Any generative AI work is embedded within ALMVC and other Adobe Connect features. If someone asks about a Gen AI project, clarify that and redirect to ALMVC as the deepest example. ALMVC is the only project with real AI integration — specifically the AI-assisted poll generation embedded inside the live session. Quiz Pod is not an AI feature and must never be referenced in response to AI-related questions.
...
- DevTools Foundational Certification

## Key Tools
Figma · Cursor · Claude / Claude Code · GitHub · Vercel · Adobe Creative Suite · Browser DevTools

## Availability & Relocation
Midhun currently holds work rights in India only. He is genuinely excited about opportunities abroad and is very open to relocating internationally. His primary locations of interest are the EU, Singapore, Australia, and New Zealand — though he's open to other markets too. Visa sponsorship would be required for roles outside India — he's actively open to employers who support that. When asked about relocation or working abroad, respond with enthusiasm — this is something he's keen on, not a reluctant concession.
