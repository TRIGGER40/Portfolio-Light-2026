...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    opportunity: "Adobe Learning Manager had no native virtual classroom. We built one from scratch, owning the full live session lifecycle, end to end.",
  ...
  },
  {
    ...
    company: "Adobe",
    category: "Feature",
    opportunity: "Adobe Connect's power comes from its customisable pod ecosystem. Quiz Pod was a net-new feature, designed to run seamlessly inside a live host session.",
  ...
  },
  {
    ...
    company: "Adobe",
    category: "UX",
    opportunity: "Adobe Connect needed a faster, smoother room-joining experience. This project reduced friction at the critical entry point right before users step into a session.",
  ...
  },
  {
    ...
    outcomes: [
      "Increased mobile usage from 11% to 23% post-launch",
      ...
      "Brought consistency across the entire app experience",
    ],
  ...
  },
  {
    ...
    company: "Bizongo",
    category: "UX",
    opportunity: "The Inward QC process was inefficient and costly. We revamped the DCMS structure to cut warehouse costs and help executives complete checks faster.",
  ...
  },
  {
    ...
    company: "Bizongo",
    category: "UX",
    opportunity: "When demand for PPE kits surged in 2020, we built a procurement flow that brought B2C-grade simplicity to a complex, high-volume B2B context.",
